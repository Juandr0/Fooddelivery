...
import fragment.user.CategoryItalianFragment

class CategoryItalianRecyclerAdapter(val context: CategoryItalianFragment, val restaurants: List<Restaurant>) :
    RecyclerView.Adapter<CategoryItalianRecyclerAdapter.ViewHolder>() {
