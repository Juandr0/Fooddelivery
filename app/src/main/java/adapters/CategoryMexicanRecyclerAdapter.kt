...
import fragment.user.CategoryMexicanFragment

class CategoryMexicanRecyclerAdapter(val context: CategoryMexicanFragment, val restaurants: List<Restaurant>) :
    RecyclerView.Adapter<CategoryMexicanRecyclerAdapter.ViewHolder>() {
