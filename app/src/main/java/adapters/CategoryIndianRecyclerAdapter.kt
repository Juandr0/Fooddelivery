...
import fragment.user.CategoryIndianFragment

class CategoryIndianRecyclerAdapter(val context: CategoryIndianFragment, val restaurants: List<Restaurant>) :
    RecyclerView.Adapter<CategoryIndianRecyclerAdapter.ViewHolder>() {
