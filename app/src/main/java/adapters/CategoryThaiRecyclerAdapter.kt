...
import fragment.user.CategoryThaiFragment

class CategoryThaiRecyclerAdapter (val context: CategoryThaiFragment, val restaurants: List<Restaurant>) :
    RecyclerView.Adapter<CategoryThaiRecyclerAdapter.ViewHolder>() {
