...
class MaxLiljeholmenMenuRecyclerAdapter (val context: MaxLiljeholmenMenuFragment, val orderItems: List<OrderItem>) :
    RecyclerView.Adapter<MaxLiljeholmenMenuRecyclerAdapter.ViewHolder>() {
