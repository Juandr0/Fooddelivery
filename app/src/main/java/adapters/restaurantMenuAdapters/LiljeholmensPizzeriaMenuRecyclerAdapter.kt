...
class LiljeholmensPizzeriaMenuRecyclerAdapter (val context: LiljeholmesnPizzeriaMenuFragment, val orderItems: List<OrderItem>) :
    RecyclerView.Adapter<LiljeholmensPizzeriaMenuRecyclerAdapter.ViewHolder>() {
