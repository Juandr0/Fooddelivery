...
class IndianGardenMenuRecyclerAdapter (val context: IndianGardenMenuFragment, val orderItems: List<OrderItem>) :
    RecyclerView.Adapter<IndianGardenMenuRecyclerAdapter.ViewHolder>() {
