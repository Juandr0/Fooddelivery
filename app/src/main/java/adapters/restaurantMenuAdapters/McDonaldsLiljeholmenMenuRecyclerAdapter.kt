...
class McDonaldsLiljeholmenMenuRecyclerAdapter (val context: McDonaldsLiljeholmenMenuFragment, val orderItems: List<OrderItem>) :
    RecyclerView.Adapter<McDonaldsLiljeholmenMenuRecyclerAdapter.ViewHolder>() {
