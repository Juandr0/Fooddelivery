...
class BrodernasMenuRecyclerAdapter (val context: BrodernasMenuFragment, val orderItems: List<OrderItem>) :
    RecyclerView.Adapter<BrodernasMenuRecyclerAdapter.ViewHolder>() {
