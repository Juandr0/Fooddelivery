...
class TrattoriaGrazieMenuRecyclerAdapter(val context: TrattoriaGrazieMenuFragment, val orderItems: List<OrderItem>) :
    RecyclerView.Adapter<TrattoriaGrazieMenuRecyclerAdapter.ViewHolder>() {
