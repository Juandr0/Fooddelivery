...
class MaxadPizzaMenuRecyclerAdapter (val context: MaxadPizzaMenuFragment, val orderItems: List<OrderItem>) :
    RecyclerView.Adapter<MaxadPizzaMenuRecyclerAdapter.ViewHolder>() {
