...
import adapters.restaurantMenuAdapters.IndianGardenMenuRecyclerAdapter
 ...
 * Use the [IndianGardenMenuFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class IndianGardenMenuFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_indian_garden_menu, container, false)
    }
        ...
        FirebaseFirestore.getInstance().collection("restaurants").document("RF1GfTjrS8DQYcVzVjZ7").collection("menu")
            ...
            .addOnSuccessListener { documents ->
                for(document in documents){
                    ...
                    var recyclerView = view.findViewById<RecyclerView>(R.id.indianGardenMenuItemsRecyclerView)
                    ...
                    val adapter = IndianGardenMenuRecyclerAdapter(this, orderItem)
    ...
    companion object {
         ...
         * @return A new instance of fragment IndianGardenMenuFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            IndianGardenMenuFragment().apply {
