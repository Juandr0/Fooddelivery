...
import adapters.restaurantMenuAdapters.TacoBarMenuRecyclerAdapter
 ...
 * Use the [TacoBarMenuFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class TacoBarMenuFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_taco_bar_menu, container, false)
    }
        ...
        FirebaseFirestore.getInstance().collection("restaurants").document("sxPm5xMT8dQYuBT7L78u").collection("menu")
            ...
            .addOnSuccessListener { documents ->
                for(document in documents){
                    ...
                    var recyclerView = view.findViewById<RecyclerView>(R.id.tacoBarMenuItemsRecyclerView)
                    ...
                    val adapter = TacoBarMenuRecyclerAdapter(this, orderItem)
    ...
    companion object {
         ...
         * @return A new instance of fragment TacoBarMenuFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            TacoBarMenuFragment().apply {
