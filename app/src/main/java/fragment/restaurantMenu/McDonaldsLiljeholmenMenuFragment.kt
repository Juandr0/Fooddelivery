...
import adapters.restaurantMenuAdapters.McDonaldsLiljeholmenMenuRecyclerAdapter
 ...
 * Use the [McDonaldsLiljeholmenMenuFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class McDonaldsLiljeholmenMenuFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_mc_donalds_liljeholmen_menu, container, false)
    }
        ...
        FirebaseFirestore.getInstance().collection("restaurants").document("MYTJUx2kyeSyfHjwUy5n").collection("menu")
            ...
            .addOnSuccessListener { documents ->
                for(document in documents){
                    ...
                    var recyclerView = view.findViewById<RecyclerView>(R.id.mcDonaldsLiljeholmenMenuItemsRecyclerView)
                    ...
                    val adapter = McDonaldsLiljeholmenMenuRecyclerAdapter(this, orderItem)
    ...
    companion object {
         ...
         * @return A new instance of fragment McDonaldsLiljeholmenMenuFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            McDonaldsLiljeholmenMenuFragment().apply {
