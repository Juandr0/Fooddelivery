 ...
 * Use the [LiljeholmesnPizzeriaMenuFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class LiljeholmesnPizzeriaMenuFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment LiljeholmesnPizzeriaMenuFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            LiljeholmesnPizzeriaMenuFragment().apply {
