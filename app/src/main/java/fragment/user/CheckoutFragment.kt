...
class CheckoutFragment : Fragment() {
    ...
    fun sendOrderToDb() {
        ...
        currentUser.get()
            .addOnSuccessListener { document ->
                ...
                val docref = db.collection("orders").document(auth.currentUser!!.uid).collection("UserOrders")
                    .add(dataToBeSent)
    ...
    fun updateUserLastOrder() {
        ...
        val updateMap = mapOf(
            restaurantHeaderTextView.text.toString() to "lastOrder",
            newOrderItemList to "lastOrderRestaurant"
        )
...
private fun Any.update(updateMap: Map<Any, String>) {
