...
class ExploreFragment : Fragment() {
        ...
        adapter.setOnItemClickListener(object: FoodCategoryRecyclerAdapter.onItemClickListener{
            override fun onItemClick(position: Int) {
                ...
                when(position){
                    ...
                    5->{
                        setCurrentFragment(CategoryVegetarianFragment)
                    }
                    6->{
                    ...
                    8->{
                        setCurrentFragment(CategoryMexicanFragment)
                    }
    ...
    private fun setCurrentFragment(fragment : Fragment){
        ...
        val transaction = fragmentManager.beginTransaction().addToBackStack("ExploreFragment")
