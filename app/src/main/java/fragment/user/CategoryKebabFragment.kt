 ...
 * Use the [CategoryKebabFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class CategoryKebabFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_category_kebab, container, false)
    }
        ...
        FirebaseFirestore.getInstance().collection("restaurants")
            ...
            .addOnSuccessListener { documents ->
                for(document in documents){
                    ...
                    var recyclerView = view.findViewById<RecyclerView>(R.id.kebabRecyclerView)
                    ...
                    val adapter = CategoryKebabRecyclerAdapter(this, restaurant)
    ...
    companion object {
         ...
         * @return A new instance of fragment CategoryKebabFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            CategoryKebabFragment().apply {
